...
### always pass local variables for templates

1. <https://stackoverflow.com/a/38653180/3632318>

just like when rendering partials in Rails: pass all local variables
explicitly and don't reference global variables (even though they are
available).

`vars` option is used to pass local variables to the template:

...
NOTE: passing `app_name` local variable here is not required - it might
      be better to hardcode application name inside the template if this
      template is stored inside application role.

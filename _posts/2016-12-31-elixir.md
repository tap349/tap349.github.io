...
- capture and partially apply named function
  ...
  in fact named function can be captured in 2 ways:
  ...
  iex> fun_1 = &Foo.test(1, &1, &2)
  #Function<12.99386804/2 in :erl_eval.expr/5>
  iex> fun_1.(2, 3)
  5

  iex> fun_2 = &Foo.test(&1, 2, &2)
  #Function<12.99386804/2 in :erl_eval.expr/5>
  iex> fun_2.(1, 3)
  5

  iex> fun_3 = &Foo.test(1, 2, &1)
  #Function<6.99386804/1 in :erl_eval.expr/5>
  iex> fun_3.(3)
  5

  iex> fun_4 = &Foo.test(&1, &2, 3)
  #Function<12.99386804/2 in :erl_eval.expr/5>
  iex> fun_5 = &fun_4.(&1, 2)
  #Function<6.99386804/1 in :erl_eval.expr/5>
  iex> fun_5.(1)
...
- just calls `__using/1__` macro on that module (to inject some code into current context)

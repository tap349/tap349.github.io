...
**WARNING**: obsolete section - see [rails console](#rails-console)
...
to fix add initializer _config/initializers/i18n.rb_:
...
adding this iniatializer fixes locale for rspec as well -

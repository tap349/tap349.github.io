...
- `docker ps`
  ...
  7325284db500   v***n/n**   "rackup -o 0.0.0.0..."   Up About an hour   0.0.0.0:4321->4321/tcp   server_app_1
  e0ef57d5ac7c   postgres    "docker-entrypoint..."   Up About an hour   5432/tcp                 server_db_1
  ```

  note that `CREATED` column is removed from output for the sake of readability.

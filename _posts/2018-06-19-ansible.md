...
- conditional statements
  ...
  never use double-curly braces and double quotes even if statement contains
  variables:
...
- variables or templates
  ...
  variables are always referenced using double-curly braces, variables and
  templates must be surrounded with double quotes:
...
- bare strings
  ...
  bare strings (including paths) are never surrounded with double quotes:

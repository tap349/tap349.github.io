...
next line - use `{% if ... -%}` (note minus sign) to disable indentation of
the 1st line of the block and add empty line after `{% endif %}` to disable
indentation of the 1st line after the block:

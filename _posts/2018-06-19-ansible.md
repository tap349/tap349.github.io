...
(how to) print warning
----------------------

1. <https://medium.com/opsops/how-to-print-warning-from-a-task-3286ebb39f40>

strictly it's not a warning but still `fail` module is better suited to print
warnings than `debug` module in that the former uses a red color:

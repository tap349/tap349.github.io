...
- wraps QtWebKit
- has system dependency - Qt libraries
...
- has system dependency - PhantomJS (installs QtWebKit as dependency)
...
whenever you would use any standard driver.
...
```ruby
Capybara.default_selector = :xpath # css by default
find('//ul/li').text
```
...
**NOTE**: RackTest driver doesn't support calling remote servers -
